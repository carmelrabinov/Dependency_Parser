...
class DependencyParser:
    ...
    def train(self, data_path, test_path=None, patience=0, lr_patience=0, lr_factor=1, min_lr=0.2, shuffle=False, init_w=None, max_iter=20, mode='base', bins_list=[5,10,20,30]):
        """
